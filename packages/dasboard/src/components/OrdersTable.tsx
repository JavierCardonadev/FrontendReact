...
import { useOrderStore } from 'shared';
...
const OrdersTable: React.FC<OrdersTableProps> = ({ userId }) => {
      ...
      <div className="table-cart">
        ...
        {userOrders(userId).map((item) => (
          ...
          <span className="text-left">
            ...
            <span className="text-left get-detail" onClick={()=> navigate(`/dashboard/order/${item.id}`)}>Detalle</span>
          </div>
        ))}
      </div>
    </div>
